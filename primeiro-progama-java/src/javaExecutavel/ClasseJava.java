	...
	public static void main(String[] args) {
		...
		if (new PermitirLogin(permissao).autenticar()) {
			...
			for (Aluno aluno : listAprovados) {
				System.out.println("Nome: " + aluno.getNome() + " " + aluno.getAlunoAprovado() + " com m�dia: "
						+ aluno.getNotaMedia());
				for (Disciplina disci : aluno.getDisciplinas()) {
					System.out.println("Mat�ria: " + disci.getDisciplina() + " -> " + "Nota: " + disci.getNota());
				}
			}
...
/*
 * /* Algoritmo que troca um objeto de uma posi��o dentro da lista for (int pos
 ...
 * 
 * System.out.println("Mat�ria : " + disc.getDisciplina() + "," + " nota = " +
 * disc.getNota());
 * 
 * } System.out.println(
 * "---------------------------------------------------------"); }
